...
public class LinphoneService extends Uc3Service {
...
//                    call.acceptWithParams(params);
                    Intent intent = new Intent(LinphoneService.this, incoming.class);
...
//
//                        Toast.makeText(LinphoneService.this, "back", Toast.LENGTH_SHORT).show();
